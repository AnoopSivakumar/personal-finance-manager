...
-- =========================
-- Table: events
-- Groups income and expense records for trips, parties, and other activities.
-- =========================
...
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS event_id INTEGER REFERENCES events(id) ON DELETE CASCADE;
